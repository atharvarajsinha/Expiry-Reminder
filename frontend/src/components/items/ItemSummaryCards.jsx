...
import { summarizeItems } from '../../utils/status.js';
 ...
 *
 * The first counts items; the other three count *dates*, so one vehicle with
 * insurance, PUC and fitness contributes one item and three dates. That is the
 * honest reading: a "valid" count of items would hide a lapsed PUC behind a
 * current insurance policy.
 */
export function ItemSummaryCards({ items }) {
...
export function ItemSummaryCardsSkeleton() {
  return (
    <SkeletonGroup
