...
const NOT_AVAILABLE = 'Not set';

/**
 * A titled card used for each section of the item detail page.
 */
 ...
 * implied by layout. Missing values are shown as "Not set" instead of being
 * hidden, because "we have no issuer for this" is itself information.
 */
